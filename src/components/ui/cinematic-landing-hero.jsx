...
export function CinematicHero({
  ...
  const description = cardDescription ?? (
    <><span className="text-white font-semibold">{brandName}</span> empowers sponsors and sponsees in 12-step recovery programs with structured accountability, precise sobriety tracking, and beautiful visual timelines.</>
  );
