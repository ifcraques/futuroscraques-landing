...
const contactInfo = [
  ...
  { icon: '💬', label: 'WhatsApp', value: '(11) 93951-5008', href: 'https://wa.me/5511939515008' },
  { icon: '📍', label: 'Endereço', value: 'Avenida Tiradentes, nº 960 - Anexo 998 - 4º andar, Luz - São Paulo, SP - CEP 01102-000', href: 'https://www.google.com/maps/search/Avenida+Tiradentes+960+Luz+São+Paulo' },
]

const horarios = [
  { dia: 'Segunda', horario: 'Fechado', status: 'fechado' },
  { dia: 'Terça', horario: '10h às 16h', status: 'aberto' },
  { dia: 'Quarta', horario: '14h às 16h', status: 'aberto' },
  { dia: 'Quinta', horario: '10h às 16h', status: 'aberto' },
  { dia: 'Sexta', horario: '10h às 16h', status: 'aberto' },
  { dia: 'Sábado', horario: 'Fechado', status: 'fechado' },
  { dia: 'Domingo e Feriados', horario: 'Fechado', status: 'fechado' },
]
      ...
      <section className="section">
        <div className="contact-layout">
          ...
          >
            ...
            >
              <h3 style={{ marginTop: '2rem', marginBottom: '1.5rem', fontSize: '1.1rem', fontWeight: 700 }}>
              ...
              <div className="horarios-grid">
                {horarios.map((h, i) => (
                  <motion.div
                    key={h.dia}
                    className={`horario-item ${h.status}`}
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.5 + i * 0.05 }}
                  >
                    <span className="dia-semana">{h.dia}</span>
                    <span className={`horario-texto ${h.status}`}>{h.horario}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
